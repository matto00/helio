...
## Purpose
The login-flow verification step: after primary auth succeeds for an MFA-enabled account (password
form or OAuth callback), the user enters a TOTP or backup code before a session exists client-side.
