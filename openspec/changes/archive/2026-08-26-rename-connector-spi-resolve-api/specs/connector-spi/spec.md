...
- FROM: `### Requirement: Shared Connector lifecycle trait`
- TO: `### Requirement: Shared ConnectorDriver lifecycle trait`

- FROM: `### Requirement: SqlConnector and RestApiConnector implement Connector`
- TO: `### Requirement: SqlConnectorDriver and RestApiConnectorDriver implement ConnectorDriver`

- FROM: `### Requirement: Connector capability metadata`
- TO: `### Requirement: ConnectorDriver capability metadata`
