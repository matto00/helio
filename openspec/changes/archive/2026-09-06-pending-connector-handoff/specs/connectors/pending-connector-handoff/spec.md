# pending-connector-handoff Specification
...
Evaluation-1.md CR5: `schemas/sources/create-pending-connector-request.schema.json` pins `POST
/api/connectors/pending`'s request body (name/kind/baseUrl/authType/apiKeyName/apiKeyPlacement -- never a
credential value).
