# modal-emptystate-touch-targets Specification

## Purpose
Mobile (≤768px) minimum tap-target sizing for shared Modal chrome (`.ui-modal__close`, `.ui-modal-btn`) and the EmptyState CTA (`.ui-empty-state__cta`) — with desktop density preserved and CSS-lock regression guards.
## Requirements
