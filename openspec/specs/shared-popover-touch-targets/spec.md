# shared-popover-touch-targets Specification

## Purpose
Mobile (≤768px) minimum tap-target sizing for shared popover/menu controls — `ui-select` option rows and trigger, and actions-menu items and trigger — with desktop density preserved and CSS-lock regression guards.
## Requirements
