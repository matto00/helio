...
## Purpose
Backend TOTP MFA lifecycle: per-user data model, enrollment (secret issuance + live-code confirmation), single-use backup codes, status, and disable with re-authentication.
## Requirements
