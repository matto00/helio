# authoring-error-telemetry Specification

## Purpose
Give the NL dashboard-authoring flow distinct, UI-branchable failure kinds and a structured
per-request telemetry trail (goal → proposal → apply outcome), in place of opaque error bodies
