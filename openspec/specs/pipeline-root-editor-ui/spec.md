...
## Purpose
Gives a pipeline's root set an editor surface — per-root lane columns, the "+ root" inline-source flow,
root removal with placement-count reporting, and multi-root lane-path rendering.
