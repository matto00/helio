...
## Purpose
Shared `CreateSourceEnvelope.build` helper, keyed off `ConnectorDriver[Config].inferSchema`, that
gives any connector a diagnosable, retryable create-time `CreateSourceResponse` envelope by
construction.
