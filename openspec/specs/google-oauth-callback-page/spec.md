# google-oauth-callback-page Specification

## Purpose
Frontend `/auth/callback` page: exchanges the Google OAuth authorization code with the backend and
routes the browser onward.
## Requirements
