# dashboard-get-or-create Specification

## Purpose
Lets a caller idempotently get-or-create a dashboard by owner-scoped name, so an agentic rebuild client no
longer needs to list every dashboard and linear-scan for a name match before creating.
## Requirements
