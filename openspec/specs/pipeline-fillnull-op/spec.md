# pipeline-fillnull-op Specification

## Purpose
The `fillnull` pipeline step replaces null cells in named columns using a constant value,
forward-fill, or a computed column statistic (mean/median/mode), preserving the input schema.
## Requirements
