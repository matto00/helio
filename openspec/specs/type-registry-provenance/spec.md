# type-registry-provenance Specification

## Purpose
Type Registry list surfaces (desktop sidebar and phone section sheet) show each DataType's
producing pipeline as an at-a-glance provenance subtitle, derived client-side from the loaded
pipelines state.
## Requirements
