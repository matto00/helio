...
Validation at this layer is structural only. Whether a field list is *consistent with* the bound
dataset's declared schema is surfaced at author time by the field-type builder, and is out of
