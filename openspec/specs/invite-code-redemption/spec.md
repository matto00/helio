# invite-code-redemption Specification

## Purpose
Single-use, recipient-bound, hash-stored invite codes whose redemption atomically upgrades a free user's tier to beta, with used/invalid/foreign codes rejected by one oracle-free error.
## Requirements
