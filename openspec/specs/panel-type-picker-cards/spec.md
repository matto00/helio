...
#### Scenario: All six panel types have descriptions
- **WHEN** the type-select step is rendered
- **THEN** cards for metric, chart, text, table, markdown, and image SHALL each show a non-empty description string
